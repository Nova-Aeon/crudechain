...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_crudechain_crude_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "crudechain.crude.Post.creator":
		return x.Creator != ""
	case "crudechain.crude.Post.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: crudechain.crude.Post"))
		}
		panic(fmt.Errorf("message crudechain.crude.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message crudechain.crude.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "crudechain.crude.Post.creator":
		panic(fmt.Errorf("field creator of message crudechain.crude.Post is not mutable"))
	case "crudechain.crude.Post.id":
		panic(fmt.Errorf("field id of message crudechain.crude.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: crudechain.crude.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in crudechain.crude.Post", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: crudechain/crude/post.proto
...
var File_crudechain_crude_post_proto protoreflect.FileDescriptor

var file_crudechain_crude_post_proto_rawDesc = []byte{
...
var (
	file_crudechain_crude_post_proto_rawDescOnce sync.Once
	file_crudechain_crude_post_proto_rawDescData = file_crudechain_crude_post_proto_rawDesc
)

func file_crudechain_crude_post_proto_rawDescGZIP() []byte {
	file_crudechain_crude_post_proto_rawDescOnce.Do(func() {
		file_crudechain_crude_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_crudechain_crude_post_proto_rawDescData)
	})
	return file_crudechain_crude_post_proto_rawDescData
}

var file_crudechain_crude_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_crudechain_crude_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: crudechain.crude.Post
}
var file_crudechain_crude_post_proto_depIdxs = []int32{
...
func init() { file_crudechain_crude_post_proto_init() }
func file_crudechain_crude_post_proto_init() {
	if File_crudechain_crude_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_crudechain_crude_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_crudechain_crude_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_crudechain_crude_post_proto_goTypes,
		DependencyIndexes: file_crudechain_crude_post_proto_depIdxs,
		MessageInfos:      file_crudechain_crude_post_proto_msgTypes,
	}.Build()
	File_crudechain_crude_post_proto = out.File
	file_crudechain_crude_post_proto_rawDesc = nil
	file_crudechain_crude_post_proto_goTypes = nil
	file_crudechain_crude_post_proto_depIdxs = nil
}
